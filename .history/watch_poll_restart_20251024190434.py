...
def start_mkdocs():
    ...
    # stdout/stderr go to container logs
    # Activamos livereload en el puerto 35729 para que el navegador reciba la señal de recarga
    p = subprocess.Popen(['mkdocs', 'serve', '-a', '0.0.0.0:8000', '--livereload', '--livereload-port', '35729'])
    return p
