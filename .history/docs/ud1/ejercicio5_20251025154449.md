...
Ahora conviene verificar explícitamente por qué la tercera ecuación no aporta nueva información (esto es lo que antes se resumió como "se verifica automáticamente"). Sustituimos $\alpha=-\gamma$ y $\beta=-\gamma$ en la tercera ecuación:
