...
Con nuestros vectores, esto es:\(c_{1}\cdot \left(\begin{matrix}1\ 0\ 2\end{matrix}\right)+c_{2}\cdot \left(\begin{matrix}2\ 1\ 3\end{matrix}\right)+c_{3}\cdot \left(\begin{matrix}3\ 1\ 5\end{matrix}\right)=\left(\begin{matrix}0\ 0\ 0\end{matrix}\right)\)Ahora, sigamos el proceso. 
