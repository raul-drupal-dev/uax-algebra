...
La suma de vectores se hace componente a componente. Sumamos todas las primeras componentes, luego todas las segundas, y así sucesivamente:\(\left(\begin{matrix}c_{1}+2c_{2}+3c_{3}\ 0+c_{2}+c_{3}\ 2c_{1}+3c_{2}+5c_{3}\end{matrix}\right)=\left(\begin{matrix}0\ 0\ 0\end{matrix}\right)\)
