...
def start_mkdocs():
    ...
    # Activamos livereload para que el navegador reciba la señal de recarga
    # Nota: no especificamos el puerto porque algunas versiones de mkdocs no aceptan --livereload-port
